...
(function( $ ) {
    ...
    function money_format(a){x=(a+"").split(".");x1=x[0];x2=1<x.length?"."+x[1]:"";for(a=/(\d+)(\d{3})/;a.test(x1);)x1=x1.replace(a,"$1,$2");x2=Number(x2).toFixed(2);return"$"+x1+x2.substr(1)}
    ...
    $.fn.slider.defaults = {
        ...
        formater: function(value) {
            ...
            var finalValue = money_format(currentNumber);
            return finalValue;
